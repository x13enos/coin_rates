defmodule CoinRates.AccountsTest do
  ...
  describe "credentials" do
    alias CoinRates.Accounts.Credential
  ...
  describe "users" do
    ...
    @valid_attrs %{crypted_password: "some crypted_password", email: "some email", name: "some name"}
